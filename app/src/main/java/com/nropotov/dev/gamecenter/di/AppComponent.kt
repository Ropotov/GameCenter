...
import com.nropotov.dev.games_data.di.GamesDataBindsModule
import dagger.Component
import javax.inject.Singleton

@Singleton
@Component(modules = [ProvideGamesApiModule::class, GamesBindsModule::class, GamesDataBindsModule::class, AppBindsModule::class])
